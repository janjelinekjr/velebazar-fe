...
// theme customization
export const themeMain = (colors: colorPaletteType = colorPalette) => createTheme({
    palette: {
        primary: {
...
document.documentElement.style.setProperty('--background-color', `${themeMain().palette.appBackground?.main}`)